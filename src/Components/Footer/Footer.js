        ...
        <div>
          ...
          <div className="form-control w-80">
            ...
            <div className="relative">
              <input type="text" placeholder="username@site.com" className="input input-bordered border border-black w-full pr-16" />
              <button className="btn bg-black text-white absolute top-0 right-0 rounded-l-none px-2 ">Sign Me Up</button>
            </div>
          </div>
        </div>
      </div>
